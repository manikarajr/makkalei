...
values = [
    ...
    {
      title: 'Collaboration',
      description: 'We believe in the power of teamwork, working closely with clients and each other.',
  ...
  team = [
    ...
    { name: 'Lisa Anderson', role: 'Project Manager' },
    { name: 'James Wilson', role: 'Full Stack Developer' },
